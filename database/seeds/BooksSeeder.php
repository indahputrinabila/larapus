...
class BooksSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $book = Book::create(['title'=>'Membingkai Surga Dalam Rumah Tangga','amount'=>4,'author_id'=>$author3->id]);
        $book = Book::create(['title'=>'Cinta & Seks Rumah Tangga muslim','amount'=>3,'author_id'=>$author3->id]);
